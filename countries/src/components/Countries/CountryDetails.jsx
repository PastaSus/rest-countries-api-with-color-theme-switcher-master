  ...
  return (
    <>
      ...
      <div className="px-4 py-8">
        <Link
          to="/"
          className="mb-6 inline-block rounded-md bg-white px-4 py-2 text-(--Grey-950) no-underline shadow-md dark:bg-slate-800"
        >
          ← Back
        </Link>

        <div className="mt-8">
          <div className="mb-8 w-full overflow-hidden rounded-md">
            <img
              src={flagSrc}
          ...
          <h1 className="mb-4 text-2xl font-bold">{countryName}</h1>
              ...
              {borderCountries.length ? (
                borderCountries.map((b) => (
                  <Link
                    ...
                    className="rounded-md bg-white px-4 py-2 shadow-md dark:bg-slate-800"
                  >
                    {b.name}
                  </Link>
                ))
